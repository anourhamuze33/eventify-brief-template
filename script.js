...
function affichage(id, title, seats, price, badge) {
 //table_id// !!!!we can do it with id!!!!
  ...
  //instead of - we turn it to uppercase!!!!!!eventIIIIId!!!!!!!!
// object qui contient les infos stockees dans array events
      const event_infos = {
    id,
...
// fonction render status pour calculer le prix totale et le tatal des  seates.
...
//application de fonction appli sur l'archive et list des events
